...
if(isset($_POST['s']))
{
	...
	if(ncheck()=='y' && echeck()=='y' && phcheck()=='y' && pwcheck()=='y')
	{
		include"connection.php";
			...
			$q="insert into  hostel_reg (HNAME ,  HPHONE , HEMAIL , PASSWORD  )
			values('".$n."','".$p."','".$e."','".$pw."')";
			
			$sq=mysqli_query($cn,$q);
				if($sq)
				{
					echo '<script>alert("your hostel is registered")</script>';
					$n=$ns=$e=$es=$p=$ps=$pw=$pws='';
				}
				else
				{
...
<div class="fluid-container">
	<div class="row">
			<div class="col-md-8 offset-md-2">
						<div class="m">
					<hr>
<a style=" text-align: center";><h2><u>HOSTEL OWNER REGISTRATION FORM </u></h2></a>
<hr>
<br><br>
