...
<nav class="navbar navbar-expand-lg navbar-light bg-info">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      ...
      <a class="nav-item nav-link text-white" href="hroom.php">ROOM</a>
      <a class="nav-item nav-link text-white" href="hbook.php">BOOKING</a>
...
if(isset($_POST['s']))
{
	...
	$ty=$_POST['ty'];
		include"connection.php";
			...
			values('".$ty."','".$rl."','".$rr."','".$ds."','".$ftpd."','".$_SESSION['hhid']."')";
...
<style>
.m{margin:5px;min-height:300px;background-color:cyan;}
...
$q="select * from room_reg where hid='".$_SESSION['hhid']."'";
	$sq=mysqli_query($cn,$q);
						...
						echo '<div class="col-md-4">';
							echo'<div class="m">'; 
									...
									echo ' || HID= '.$r['HID'];
											...
											echo ' <br>Room DETAILS :  '.$r['RDETAIL'];
											
											
											$h_rdel=$r['RID'];
											echo '<br><a href="h_rdel.php?h_rdel='.$h_rdel.' "> delete</a>';
